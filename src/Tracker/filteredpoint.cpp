...
void FilteredPoint::Initialize(double time_step, Point init_position, Point init_velocity)
{
...
Point FilteredPoint::State(const unsigned & index)
{
	Point p;
...
Point FilteredPoint::Predicted_state(const unsigned & index)
{
	Point p;
...
void FilteredPoint::Next_Measurement(Point & measurement)
{
