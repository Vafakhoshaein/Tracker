...
**
** Created: Wed Feb 29 12:50:13 2012
...
static const char qt_meta_stringdata_SettingView[] = {
    "SettingView\0"
};

const QMetaObject SettingView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SettingView,
      qt_meta_data_SettingView, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SettingView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SettingView))
